      ...
      <div className='mb-3 max-w-2xl flex'>
        <div className='relative mb-4 flex w-full flex-wrap items-stretch '>
          ...
          <span
            ...
            id="basic-addon2" data-te-ripple-color="light">
            <svg
            ...
            <th className="py-4 px-8 cursor-pointer" onClick={() => handleSort('id')}>
              ID {sortField === 'id' && (
                sortDirection === 'asc' ? (
                  ...
                  <svg className='inline-block' width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex items-center justify-between my-4">
        ...
        <div>
          {Array.from({ length: 5 }).map((_, index) => (
            <button
              key={index + 1}
              className={`mx-1 px-3 py-2 rounded-md ${currentPage === index + 1 ? 'text-white cursor-default' : 'text-black cursor-pointer'}`}
